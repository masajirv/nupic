...
control = {
  ...
  #
  'dataset' : {   u'info': u'taiyoukou-data',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'taiyoukou',
                            u'source': u'file://taiyoukou.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'V13',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'V13', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'V13', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
