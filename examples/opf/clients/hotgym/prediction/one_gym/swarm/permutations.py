...
'/usr/local/lib/python2.7/dist-packages/nupic/swarming/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'V13': PermuteEncoder(maxval=640.932, fieldName='V13', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=640.932, classifierOnly=True, clipInput=True, minval=0.0, n=PermuteInt(28, 521), fieldname='V13', w=21, type='ScalarEncoder', ),
  u'V3': PermuteEncoder(maxval=1063.637, fieldName='V3', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  u'V10': PermuteEncoder(maxval=640, fieldName='V10', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=V13")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=V13"
